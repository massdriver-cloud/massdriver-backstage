...
// Local copy of @mui/icons-material Token (what @massdriver/ui/icons/TokenIcon
// re-exports), rendered with MUI v4 SvgIcon so the eagerly-required package
// root never evaluates @mui/material. See BundleIcon.tsx for the full
// rationale.
export const TokenIcon = (props: SvgIconProps) => (
