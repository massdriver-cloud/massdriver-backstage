...
// Local copy of @massdriver/ui/icons/BundleIcon rendered with MUI v4 SvgIcon.
// This icon is reachable from the package root (via MassdriverSidebarItem),
// which Backstage `require()`s eagerly at app boot — importing it from
// `@massdriver/ui` would pull the whole `@mui/material` barrel into the boot
// graph and freeze v5 class-name constants before Backstage configures its
// `v5-` prefix (see .claude/rules/styling-and-theme.md).
